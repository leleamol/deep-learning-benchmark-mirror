...
(1 or 2), number of layers (20, 56, or 110), number of GPUs, and number of epoch to use. 
...
Directly run the shell script to launch the benchmark, provide one of the configurations in config.json, whether 
you want to benchmark inference speed (True or False), and number of epochs to run. 
...
Directly run the shell script to launch the benchmark, provide one of the configurations in config.json, whether you want to benchmark inference speed (True or False), and number of epochs to run. 
