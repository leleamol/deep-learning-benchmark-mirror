...
from models.wideresnet22_basic import wideResnet22Basic
...
if __name__ == "__main__":
    ...
    model = wideResnet22Basic(num_classes=10)
    ...
    base_lr = 0.01
    lr_schedule = CyclicalScheduler(stepsize=iters_per_epoch*40, base_lr=base_lr, max_lr=0.1).get_schedule(80 * iters_per_epoch)
    idx = max(lr_schedule.keys())
    for i in range(20*iters_per_epoch):
        lr_schedule[idx+i+1] = lr_schedule[idx+i]*0.999
