...
from models.resnet56_basic import resnet56Basic
...
if __name__ == "__main__":
    ...
    lr_schedule = CyclicalScheduler(stepsize=iters_per_epoch*5, base_lr=0.001, max_lr=0.3).get_schedule(epochs * iters_per_epoch)
